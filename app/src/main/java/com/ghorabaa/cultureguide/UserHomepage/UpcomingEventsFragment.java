...
public class UpcomingEventsFragment extends Fragment
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate( R.layout.user_homepage_upcoming_events, container , false );

        mPosts = (RecyclerView) view.findViewById(R.id.upcoming_events);
        ...
        mRefreshButtons = (Button) view.findViewById(R.id.upcoming_events_refresh);

        mRefreshButtons.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                mUserPage.getUpcomingEvents();
            }
        });
    ...
    public void refreshPosts(View view){
        Toast.makeText(getActivity(),"Refreshing upcoming views",Toast.LENGTH_LONG).show();
    }
}
